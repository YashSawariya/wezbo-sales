package com.example.wezbosales.ui.addleads
...
import com.example.wezbosales.databinding.FragmentAddLeadsBinding

class AddLeadsFragment : Fragment() {

    private var _binding: FragmentAddLeadsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAddLeadsBinding.inflate(inflater, container, false)
        ...
        val arrayAdapter1=ArrayAdapter(requireContext(),R.layout.textview_for_dorpdown_menu,businesstype)
